return {
	...
	},
	{
		...
		keys = {
			-- `reveal toggle` covers both jobs; a separate <leader>ef would make
			-- <leader>e (diagnostic float) wait out timeoutlen on every press.
			{ "<leader>E", "<cmd>Neotree reveal toggle<CR>", desc = "Toggle Neotree (reveal file)" },
		},
	},
	{
		"stevearc/oil.nvim",
	...
	},
	{
		...
		keys = {
			...
			-- <leader>rB, not <leader>rbf: the latter delayed <leader>rb.
			{
				"<leader>rB",
	...
	},
	{
		...
		keys = {
			-- Under <leader>s, not <space>fb: the latter made <leader>f (format)
			-- wait out timeoutlen.
			{
				"<leader>sb",
	...
	},
	{
		...
		keys = {
			{ "<leader>st", "<cmd>TodoTelescope<CR>", desc = "Find all todo comments" },
			{
				...
				desc = "Find all todo comments in current buffer",
			},
		},
	},
	{
